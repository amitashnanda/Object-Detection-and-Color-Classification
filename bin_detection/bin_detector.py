...
class BinDetector():
	...
	def get_bounding_boxes(self, img):
		...
		for prop in props:
			...
			if 2.5>h/w>0.7 and 55000>w*h>5000:	
				...
				cv2.rectangle(img_2, (prop.bbox[1], prop.bbox[0]), (prop.bbox[3], prop.bbox[2]), (255, 0, 0), 2)	
...
class_call.get_bounding_boxes('data/validation/0070.jpg')
